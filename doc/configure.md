...
| `log_level`                |                                                                                     | `debug`, `trace`, `error`, `warn`, `info` |
| `log_target`               |                                                                                     | `stdout, tcp or udp address`              |
| `log_access_target`        | if activated, sends access logs to a separate target                                | `stdout`, `tcp` or `udp address`          |
